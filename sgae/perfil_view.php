                                        ...
                                        <div class="row">                                        
                                                    <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input disabled="" type="text" style="width:200px" class="form-control" id="tipo" name="tipo" value="<?php echo $tipo; ?>" required>
                                                                </div>
                                                            </div>   
                                                    </div>
                                        </div>                                                    
                                        <div class="row">
                                                    <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input disabled="" type="text" style="width:400px" class="form-control" id="descricao" name="descricao" value="<?php echo $descricao; ?>" required>
                                                                </div>
                                                            </div>   
                                                    </div>
                                        </div>                                                    
                                        <div class="row">                                        
                                                    <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input disabled="" type="text" style="width:70px" class="form-control" id="sigla" name="sigla" value="<?php echo $sigla; ?>" required>
                                                                </div>
                                                            </div>   
                                                    </div>
                                        </div>                                                    
                                        <div class="row">                                                                                        
                                                    ...
                                                    <div class="form-group form-actions">
                                                                <div class="col-md-9 col-md-offset-5">
                                                                    <button type="button" onclick="location.href='perfil_list.php?loadCriteria=true'" class="btn btn-labeled btn-success btn-responsive"><span class="btn-label"><i class="livicon" data-name="arrow-left" data-size="17" data-loop="true" data-c="#fff" data-hc="#fff" title="Voltar"></i></span>&nbsp;Voltar</button>
                                                                </div>
                                                    </div>                                                        
                                        </div>
                                    </form>
