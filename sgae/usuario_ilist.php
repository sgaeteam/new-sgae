                    ...
                    <div class="portlet box default">
                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="btn-group">
                                    <button id="sample_editable_1_new" class="btn btn-success" onclick="location.href='usuario_list.php'">
                                        Ativos
                                    </button>                                    
                                </div>
                            </div>
                            <div id="sample_editable_1_wrapper" class="">
                                <table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample_editable_1" role="grid">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Notes
                                            : activate to sort column ascending" style="width: 100px;">Perfil</th>
                                        <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Edit
                                            : activate to sort column ascending" style="width: 150px;">Unidade</th>
                                        <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Delete
                                            : activate to sort column ascending" style="width: 50px;">Habilitar</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                        <?php 
                                            $ssql = "SELECT * FROM usuario, perfil, unidade WHERE usuario.perfil_id = perfil.id and usuario.unidade_id = unidade.id and usuario.inativo = 1 ORDER BY usuario.nome DESC";
                                            $rs = mysql_query($ssql);
                                        ...
                                        ?>                                       
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td align="center">
                                                                <a class="edit" href="usuario_exec.php?act=react&idusu=<?php echo $id; ?>"><img src="img/bt_react.png" width="20" height="17" title="habilitar" alt="habilitar" border="0" align="absmiddle" style="padding-right:10px;"/></a>
                                                            </td> 
                                                        </tr>
                                        <?php      
                                                    } 
