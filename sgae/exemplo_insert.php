        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Cadastrar "Nome do item de menu"</li>
                </ol>
            </section>
                ...
                <div class="row">
                        <div class="col-lg-12">
                            <div class="alert alert-success alert-dismissable margin5">
                                ...
                                <strong>Mensagem com o resultado do cadastro. Se for sucesso, verde. Caso contrário, vermelho. Fazer desaparecer após 3 segundos.</strong>
                            </div>
                        </div>
                </div>
            </section>
                            ...
                            <div class="panel-body">
                                        ...
                                        <div class="row">
                                                    <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control" id="campo1" placeholder="Filtro1">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label col-md-3" for="filtro2">Campo 2 *</label>
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control" id="campo2" placeholder="Filtro 2">
                                                                </div>
                                                            </div>   
                                                    </div>
                                        </div>
                                    ...
                                    <div class="form-group form-actions">
                                                <div class="col-md-9 col-md-offset-5">
                                                    ...
                                                    <button type="button" onclick="" class="btn btn-labeled btn-success btn-responsive"><span class="btn-label"><i class="livicon" data-name="save" data-size="17" data-loop="true" data-c="#fff" data-hc="#fff" title="Salvar"></i></span>&nbsp;Salvar</button>
