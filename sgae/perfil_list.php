                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3" for="nomeFiltro">Perfil</label>
                                                <div class="col-md-9">
                                ...
                                <div class="form-group form-actions">
                                    <div class="col-md-9 col-md-offset-4">
                                        ...
                                        <button type="button" onclick="location.href='perfil_insert.php'" class="btn btn-labeled btn-warning btn-responsive"><span class="btn-label"><i class="livicon" data-name="plus-alt" data-size="17" data-loop="true" data-c="#fff" data-hc="#fff" title="Buscar"></i></span>&nbsp;&nbsp;Novo</button>
                                    </div>
                                </div>  
                                </br></br></br>
...
<script type="text/javascript" src="perfil_search.js"></script>
<!-- Include footer here-->   
