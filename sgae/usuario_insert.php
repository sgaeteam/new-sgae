                            ...
                            <fieldset>
                                ...
                                <div style="display: block;" class="col-md-6 display-no">
                                    <div style="" class="form-group">
                                        ...
                                        <input class="form-control" id="input-text-2" type="text" name="login" placeholder="insira usuario">
                                    </div>
                                    <div style="position: static;" class="form-group">
                                        <label for="input-text-1">
                                            Nome completo</label>
                                        <input class="form-control" id="input-text-1" placeholder="insira nome" type="text" name="nome">
                                    </div>
                                    <div style="position: static;" class="form-group">
                                        <label for="input-text-3">
                                            E-mail</label>
                                        <input class="form-control" id="input-text-3" placeholder="insira e-mail" type="email" name="email">
                                    </div>
                                </div>
                                <div style="display: block;" class="col-md-6 display-no">
                                    <div style="position: static;" class="form-group">
