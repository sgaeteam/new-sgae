...
if($obj->delete($_REQUEST['del_id'],"students")){
...
<div class="container">
  ...
  <table width="750" border="1" class="table-striped">
   ...
   <?php
    foreach($obj->read("usuario") as $value){
  	  extract($value);
  echo <<<show
    <tr class="success">
      <td>$nome</td>
      <td>$email</td>
      <td>$login</td>
      <td><button class="btn"><a href="edit.php?id=$id">Edit</a></button>&nbsp;&nbsp;<button class="btn"><a href="show.php?del_id=$id">Delete</a></button></td>
    </tr>
show;
    }
  ?>
