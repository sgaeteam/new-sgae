    ...
    <a id="back-to-top" href="#" class="btn btn-primary btn-lg back-to-top" role="button" title="Voltar para o topo" data-toggle="tooltip" data-placement="left">
    ...
    <script src="js/metisMenu.js" type="text/javascript">
    </script>
