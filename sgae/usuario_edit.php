                                        ...
                                        <div class="row">
                                                    <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control" id="login" name="login" placeholder="Digite o login" value="<?php echo $login; ?>" autofocus required/>
                                                                </div>
                                                            </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="email" class="form-control" id="email" name="email" placeholder="Digite o e-mail" data-bv-field="validateEmail" value="<?php echo $email; ?>">
                                                                </div>
                                                            </div>   
                                                    </div>                                                      
                                        </div>
